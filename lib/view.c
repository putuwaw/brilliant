...
void lihat_cari_author(){
    ...
    fflush(stdin);
    printf("|                                                                   |\n");
    printf("|  Masukkan nama penulis yang akan dicari:                          |\n");
    printf("|                                                                   |\n");
    printf("|-------------------------------------------------------------------|\n");
    pos.X = 43;
    pos.Y = 20;
    ...
    if (isFound){
        ...
        printf("|                                                                   |\n");
        printf("|  Tidak ada buku dengan nama penulis \"%s\" ditemukan!                     \n", authorSearch);
        printf("|                                                                   |\n");
        printf("|-------------------------------------------------------------------|\n");
    }
}
...
void lihat_cari_year(){
    ...
    fflush(stdin);
    printf("|                                                                   |\n");
    printf("|  Masukkan tahun terbit yang akan dicari:                          |\n");
    printf("|                                                                   |\n");
    printf("|-------------------------------------------------------------------|\n");
    pos.X = 43;
    pos.Y = 20;
    ...
    for(int i=0;i<length;i++){
        if (!isdigit(input[i])){
            printf("\a|                                                                   |\n");
            printf("|  \033[0;31mInput Harus Angka!\033[0m                                               |\n");
            printf("|                                                                   |\n");
            printf("|-------------------------------------------------------------------|\n");
            return;
        }
    ...
    if (isFound){
        ...
        printf("|                                                                   |\n");
        printf("|  Tidak ada buku pada tahun \"%d\" ditemukan!                     \n", yearSearch);
        printf("|                                                                   |\n");
        printf("|-------------------------------------------------------------------|\n");
        return;
    }
